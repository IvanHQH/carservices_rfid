                        ...
                        @foreach($operators as $operator)      
                            <tr class="gradeA odd" role="row">         
                                ...
                                <td style="text-align: center; vertical-align: middle; ">
                                    ...
                                    <a class ="delete_operator" style="cursor:pointer"
                                       title="Eliminar">
...
<div class="modal-content">                       
    ...
    <div class="tabbable" id="tabs-102605">
        ...
        <li >
            <a href="#panel-913595" data-toggle="tab">
                Autenticación</a>
        </li>                         
        </ul>
        <div class="tab-content">
            <div class="tab-pane active" id="panel-919134"><br>
            <div class="row">
                <div class="col-md-6"> 
                    <div class="form-group">
                        <label>Nombre</label>
                        <input id="operator_first_name" class="form-control" value="a">
                    </div>
                    <div class="form-group">
                        <label>Apellido Paterno</label>
                        <input id="operator_last_name" class="form-control" value="a">
                    </div>       
                    <div class="form-group">
                        <label>Apellido Materno</label>
                        <input id="operator_mother_maiden_name" class="form-control" value="a">
                    </div>                                                    
                </div>
                <div class="col-md-6">    
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input id="operator_birthdate" type="date" class="form-control" value="2015-01-01">                                      
                    </div>                      
                </div>                                     
            </div>                                               
            </div>
                ...
                <div class="row">
                    <div class="col-md-6">   
                        <div class="form-group">
                            ...
                            <input id="operator_address" class="form-control" value="a">
                        </div>        
                        <div class="form-group">
                            <label>Colonia</label>
                            <input id="operator_neighborhood" class="form-control" value="a">
                        </div>  
                        <div class="form-group">
                            <label>Estado</label>
                        ...
                        <div class="form-group">
                            <label>Ciudad</label>
                            <input id="operator_city" class="form-control" value="a">
                        </div>                                  
                    </div>  
                    <div class="col-md-6">      
                        <div class="form-group">
                            <label>Código postal</label>
                            <input id="operator_postal_code" class="form-control" value="a">
                        </div>        
                        <div class="form-group">
                            <label>Teléfono casa</label>
                            <input id="operator_home_phone" class="form-control" value="a">
                        </div>  
                        <div class="form-group">
                            <label>Teléfono móvil</label>
                            <input id="operator_cell_phone" class="form-control" value="a">
                        </div>  
                        <div class="form-group">
                            <label>Correo electrónico</label>
                            <input id="operator_email" class="form-control" value="a">
                        </div>                                 
                    </div>                                    
                 </div>                              
            </div>    
            <div class="tab-pane" id="panel-913595"> 
                <br>        
                <div class="row">
                    <div class="col-md-6">   
                        <div class="form-group">
                            <label>Nombre de Usuario</label>
                            <input id="operator_username" class="form-control" value="a">
                        </div>             
                        <div class="form-group">
                            <label>Contraseña</label>
                            <input type="password" id="operator_password" class="form-control" value="a">
                        </div>                           
                    </div>    
                    <div class="col-md-6">        
                    </div>                    
...
$.ajax({
    type: 'GET',
    url: '{{ URL::to('/states_list') }}',
    dataType: 'json',
    success: function(d) {        
        var select = $('#operator_town');
        var towns= d.states;
        for (i = 0; i < towns.length; i++)
            select.append("<option value='"+towns[i].id+"'>"+towns[i].state+"</option>");  
    }
}); 
...
$('#save_operator').on('click',function(e){
    var birth = document.getElementById("operator_birthdate");
    var data = {            
...
function fiilModalOperator(id) {
    $.ajax({
        ...
        success: function(d) {
            ...
            $("#operator_mother_maiden_name").val(d.operator.mother_maiden_name);
            $("#operator_username").val(d.operator.username);
            $("#operator_sex").val(d.operator.sex); 
            $("#date_birthdate").val(d.operator.birthdate);                                                                
            $("#operator_address").val(d.operator.address); 
            $("#operator_neighborhood").val(d.operator.neighborhood); 
            $("#operator_town").val(d.operator.town_id); 
